...
complete -c key -n __fish_use_subcommand -a config -d 'Show or change persisted settings'
...
complete -c key -s s -l safe -d 'Skip variables that already have a value'
