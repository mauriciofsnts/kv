...
complete -c kv -n __fish_use_subcommand -a use -d 'Show or pin the active group for this directory'
...
complete -c kv -n __fish_use_subcommand -a share -d 'Share a group as an encrypted QR code'
...
complete -c kv -n '__fish_seen_subcommand_from share import use' -a '(__kv_groups)'
